...
TEST_REPO_PATH = Path("tests/test_repo")  # Make sure this exists
...
def test_scan_endpoint():
    ...
    test_scan_endpoint.scan_id = data["scan_id"]  # For reuse
    assert data["repo_name"] == TEST_REPO_PATH.name


def test_summary_endpoint():
    scan_id = test_scan_endpoint.scan_id
...
def test_download_formats(format):
    scan_id = test_scan_endpoint.scan_id
...
def test_download_artifacts_zip():
    scan_id = test_scan_endpoint.scan_id
